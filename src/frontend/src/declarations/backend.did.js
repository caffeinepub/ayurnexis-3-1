...
export const idlService = IDL.Service({
  ...
  getAllUserCredits: IDL.Func([IDL.Text], [IDL.Vec(IDL.Tuple(IDL.Text, IDL.Nat))], ['query']),
  deductCredit: IDL.Func([IDL.Text], [IDL.Bool], []),
  logRiskPrediction: IDL.Func([IDL.Text, IDL.Text, IDL.Text, IDL.Nat, IDL.Text], [], []),
  getRiskAuditLog: IDL.Func([IDL.Text], [IDL.Vec(IDL.Record({ userId: IDL.Text, userName: IDL.Text, systemName: IDL.Text, riskScore: IDL.Nat, riskLevel: IDL.Text, creditsUsed: IDL.Nat, timestamp: IDL.Int }))], ['query']),
  // Batch CRUD
